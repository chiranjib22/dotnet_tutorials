...
// <Access Specifier> [Modifier] <Return Types> <Function Name>([Parameter List])
{
    // function Body / Method Body
}

// 1. Function Name : Mandatory.
// 2. Parameter List : Optional
// 3. Return Type : Mandatory. Can not return multiple values. Can return no values (void)
